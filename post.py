...
def index():
    ...
    for alike_dislike_sum in like_dislike_sum:
        like_dislike_dict[alike_dislike_sum['post_id']] = {'like_sum': alike_dislike_sum['like_sum'],
                                                           'dislike_sum': alike_dislike_sum['dislike_sum']}
    ...
    return render_template("post/postindex.html", user_id=user_id, posts=posts, comments=comments,
                           like_dislike_dict=like_dislike_dict, liked=liked, responsed_post=responsed_post)
